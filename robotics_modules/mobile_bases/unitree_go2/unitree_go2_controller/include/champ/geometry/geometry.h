...
// Define PI constants if they're not available
#ifndef M_PI
...
namespace geometry
{
    class Point : public Matrix<3,1>
    {
        public:
            ...
            float DotProduct(const Point &obj) const
            {
                float sum = 0;
            ...
            // *** 1. NON-CONST OVERLOADS (For writing: ret.X() = ...) ***
            float &X() { return (*this)(0); }
            float &Y() { return (*this)(1); }
            float &Z() { return (*this)(2); }

            // *** 2. CONST OVERLOADS (For reading inside const methods: (*this).Y()) ***
    ...
    class Rotation : public Matrix<3,3>
    {
        public:
            ...
            Rotation& operator=(const Rotation& obj) = default;
    ...
    class Transformation
    {
        public:
            ...
            Transformation& operator=(const Transformation& obj) = default;
