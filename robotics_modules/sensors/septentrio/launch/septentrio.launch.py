...
def generate_launch_description():
    ...
    pose_frame_fixer = Node(
        package="septentrio",
        executable="pose_frame_fixer_node",
        name="pose_frame_fixer",
        namespace="",
        output="screen",
        remappings=[
            ("pose", "pose"),
            ("pose/reframed", "septentrio/orientation")
        ])

    return launch.LaunchDescription([arg_file_name, arg_file_path, container, pose_frame_fixer])
